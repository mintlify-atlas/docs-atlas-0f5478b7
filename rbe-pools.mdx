...
description: Deploy and configure custom executor pools for specialized workloads like GPUs, high-memory tasks, or specific geographic regions
---
...
[Platforms](/rbe-platforms) can be used to specify custom Docker images in which to run your actions, but sometimes you want control over more properties of the executor machine - like available memory, access to GPUs, or physical location.
